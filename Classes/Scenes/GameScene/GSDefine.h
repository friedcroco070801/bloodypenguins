...
#define ROW 7
#define COLUMN 12
#define SIZE_OF_SQUARE std::fmin((GRASS_POSITION_RIGHT-GRASS_POSITION_LEFT)/COLUMN,(GRASS_POSITION_TOP - GRASS_POSITION_BOTTOM)/ROW)
...
#define	LIMIT_TOP GRASS_POSITION_LEFT + SIZE_OF_SQUARE*COLUMN
#define LIMIT_RIGHT GRASS_POSITION_BOTTOM + SIZE_OF_SQUARE*ROW
