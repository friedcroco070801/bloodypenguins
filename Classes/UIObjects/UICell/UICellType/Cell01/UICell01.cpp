...
void UICell01::idleAnimate() {
	...
	int size = cocos2d::Sprite::create("sprites/objects/cell/animation/Pikachu.png")->getContentSize().height;
	animFrames.reserve(numberSprite);
	for (int i = 0; i < numberSprite; i++) {
		animFrames.pushBack(cocos2d::SpriteFrame::create("sprites/objects/cell/animation/Pikachu.png", cocos2d::Rect(size * i, 0, size, size)));
	}
